...
1. If you don't find *exact* information and must infer from existing design or functionality, you MUST STOP and call the AskUserQuestionTool to confirm your assumptions.
2. Otherwise, if you can't fully infer the context or your confidence is medium or lower, you MUST STOP and call the AskUserQuestionTool to ask clarifying questions before proceeding.
