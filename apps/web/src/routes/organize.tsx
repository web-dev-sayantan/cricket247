      ...
      >
        ...
        >
          <div className="relative z-10 animate-stagger-1 space-y-8">
            <div className="angled-cut inline-flex w-fit items-center gap-3 border border-primary/30 bg-primary/10 px-3 py-1.5 font-bold text-primary text-xs uppercase tracking-widest shadow-[0_0_15px_rgba(var(--color-primary)/0.2)]">
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <span className="relative z-10 inline-block text-accent">
                  Ball by Ball.
                  <span className="slanted-wavy absolute -bottom-2 left-0 z-[-1] h-[4px] w-full bg-primary" />
                </span>
              </h1>
                ...
                <div className="angled-cut w-full border border-border bg-background/80 p-4 shadow-xl backdrop-blur-md">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-semibold font-serif text-foreground text-lg">
        ...
        >
          <div className="max-w-2xl space-y-4">
            ...
            >
              Tournament <span className="text-primary italic">Mastery</span>
            </h2>
